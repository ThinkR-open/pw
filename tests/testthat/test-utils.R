test_that("pw_sys_files returns the correct paths", {
  ...
  expect_true(
    ...
    info = "The DESCRIPTION file should exist in the package directory."
  )
  ...
  expect_equal(
    result,
    "",
    info = "A non-existent file should return an empty string."
  )
  ...
  expect_true(
    ...
    info = "Calling without arguments should return the root of the package."
  )
})
